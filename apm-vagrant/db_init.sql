...
--
-- Name: recipient_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE recipient_id_seq OWNER TO postgres;

--
-- Name: recipient_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
COPY recipient (id, name, mail, category) FROM stdin;
\.


--
-- Name: recipient_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: recipient_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
